...
name: daily
description: >-
  Build a one-screen morning brief from your actual day and turn it into a short
  task list: today's calendar with prep flags, emails that genuinely need you (not
  notifications), Slack messages that mention you, ticket movement, the
  commitments you made in yesterday's meetings (Wispr Flow), and whatever
  yesterday's /shutdown said you didn't get to. Ruthlessly filtered against a
  config you tune, strictly read-only on your accounts, and written to today's
  Obsidian daily note — the same file /shutdown edits in the evening. Run
  `/daily --tune` to propose filter rules from your real mail history. Triggers:
  "daily", "morning brief", "start my day", "what needs me today", "daily note",
  "plan my day".
---
