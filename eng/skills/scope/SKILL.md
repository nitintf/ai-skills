...
description: >-
  ...
  deeply, reads any PRD or user stories already written for the feature, decides
  (with the user) whether it needs a Jira ticket, whether to split into one or
  many tickets, and whether it runs the full or express track — then writes a
  planning doc per ticket into the project's .plan folder, including real
  file:line touchpoints, house conventions, and open questions for the next step.
  Use when the user describes a feature/task and wants it scoped, broken down, or
  turned into Jira tickets. Triggers: "scope this", "break this down", "turn this
  into tickets", "plan this feature".
---
