...
name: eng-review
description: >-
  Engineering-manager review of a `.plan` doc: architecture, edge cases, tests,
  performance, and consistency with how this codebase already builds things.
  Scores each and folds fixes back in.
